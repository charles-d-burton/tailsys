...
var file_sysinfo_proto_rawDesc = []byte{
	...
	0x4b, 0x65, 0x79, 0x52, 0x03, 0x6b, 0x65, 0x79, 0x22, 0x36, 0x0a, 0x18, 0x4e, 0x6f, 0x64, 0x65,
	...
	0x22, 0x00, 0x42, 0x0d, 0x5a, 0x0b, 0x2e, 0x2f, 0x63, 0x6f, 0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x73,
...
var file_sysinfo_proto_depIdxs = []int32{
	...
	7, // 4: tailsys.PingRequest.ping:type_name -> google.protobuf.Timestamp
	7, // 5: tailsys.PongResponse.ping:type_name -> google.protobuf.Timestamp
	2, // 6: tailsys.PongResponse.key:type_name -> tailsys.Key
	3, // 7: tailsys.Registration.Register:input_type -> tailsys.NodeRegistrationRequest
	5, // 8: tailsys.Pinger.Ping:input_type -> tailsys.PingRequest
	4, // 9: tailsys.Registration.Register:output_type -> tailsys.NodeRegistrationResponse
	6, // 10: tailsys.Pinger.Ping:output_type -> tailsys.PongResponse
